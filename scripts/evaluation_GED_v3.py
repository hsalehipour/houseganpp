...
# checkpoint = './checkpoints/exp_random_types_attempt_2_A_500000.pth'
...
# Generate state
def gen_state(curr_fixed_nodes_state, prev_fixed_nodes_state, sample, initial_state):
...
for run in range(5):
    ...
    # compute GED for a given sequence
...
#             dict_states = {'var_i_0': 9, 'var_i_1': 8, 'var_i_14': 3, 'var_i_15': 6, 'var_i_16': 8, 'var_i_2': 7, 'var_i_3': 8, 'var_i_4': 8, 'var_i_5': 1, 'var_i_6': 7, 'var_i_7': 9, 'var_i_9': 6, 'var_v_0': 4, 'var_v_1': 0, 'var_v_14': 6, 'var_v_15': 0, 'var_v_16': 1, 'var_v_2': 0, 'var_v_3': 1, 'var_v_4': 0, 'var_v_5': 2, 'var_v_6': 8, 'var_v_7': 7, 'var_v_9': 5}
#             dict_states = {'var_i_0': 5, 'var_i_1': 7, 'var_i_14': 7, 'var_i_15': 8, 'var_i_16': 1, 'var_i_2': 6, 'var_i_3': 8, 'var_i_4': 7, 'var_i_5': 0, 'var_i_6': 0, 'var_i_7': 9, 'var_i_9': 9, 'var_v_0': 2, 'var_v_1': 4, 'var_v_14': 4, 'var_v_15': 7, 'var_v_16': 3, 'var_v_2': 7, 'var_v_3': 5, 'var_v_4': 0, 'var_v_5': 2, 'var_v_6': 3, 'var_v_7': 0, 'var_v_9': 9}
#             dict_states = {'var_i_0': 7, 'var_i_1': 9, 'var_i_14': 9, 'var_i_15': 5, 'var_i_16': 0, 'var_i_2': 7, 'var_i_3': 9, 'var_i_4': 8, 'var_i_5': 8, 'var_i_6': 2, 'var_i_7': 8, 'var_i_9': 4, 'var_v_0': 3, 'var_v_1': 3, 'var_v_14': 8, 'var_v_15': 3, 'var_v_16': 4, 'var_v_2': 2, 'var_v_3': 0, 'var_v_4': 0, 'var_v_5': 5, 'var_v_6': 4, 'var_v_7': 7, 'var_v_9': 5}
#             dict_states = {'var_i_0': 9, 'var_i_1': 4, 'var_i_14': 0, 'var_i_15': 8, 'var_i_16': 4, 'var_i_2': 8, 'var_i_3': 3, 'var_i_4': 4, 'var_i_5': 2, 'var_i_6': 9, 'var_i_7': 8, 'var_i_9': 8, 'var_v_0': 2, 'var_v_1': 8, 'var_v_14': 6, 'var_v_15': 3, 'var_v_16': 9, 'var_v_2': 0, 'var_v_3': 9, 'var_v_4': 9, 'var_v_5': 8, 'var_v_6': 6, 'var_v_7': 4, 'var_v_9': 6}
            dict_states = {'var_i_0': 9, 'var_i_1': 4, 'var_i_14': 3, 'var_i_15': 4, 'var_i_16': 4, 'var_i_2': 8, 'var_i_3': 9, 'var_i_4': 8, 'var_i_5': 6, 'var_i_6': 5, 'var_i_7': 0, 'var_i_9': 2, 'var_v_0': 0, 'var_v_1': 6, 'var_v_14': 7, 'var_v_15': 1, 'var_v_16': 9, 'var_v_2': 0, 'var_v_3': 6, 'var_v_4': 8, 'var_v_5': 0, 'var_v_6': 0, 'var_v_7': 6, 'var_v_9': 6}
...
#                 _types += [_t for _t in all_types if (_t in per_type_mistakes.keys()) and (random.uniform(0, 1) < dict_states['var_i_{}_{}'.format(s, _t)])] # add all with mistakes with some probability
            ...
            m = estimate_graph(curr_gen_mks.copy(), real_nodes, true_graph_obj)
            mistakes.append(m)
    ...
    fid_value = calculate_fid_given_paths(['./FID/gt_small_8/', './FID/test/debug/'], 2, 'cpu', 2048)
    FIDS.append(fid_value)
    num_valid_houses = np.mean(np.array(mistakes) == 0)
    valid_houses.append(num_valid_houses)
    GED.append(np.mean(mistakes))
    with open('./FID/results_GED_{}.txt'.format(run), 'w') as f:
        f.write("\n".join([str(f) for f in GED]))
    with open('./FID/results_VH_{}.txt'.format(run), 'w') as f:
        f.write("\n".join([str(f) for f in valid_houses]))
    with open('./FID/results_FID_{}.txt'.format(run), 'w') as f:
        f.write("\n".join([str(f) for f in FIDS]))
        
print('GED: ', GED)
print(num_valid_houses)
